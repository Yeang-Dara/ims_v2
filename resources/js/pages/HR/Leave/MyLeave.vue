...
//   import Atten from '../../services/api/attendance'
  import axios from 'axios'
      ...
      export default {
          ...
          computed: {
              itemOfLeave() {
                  return this.attens.map(item => {
                      return {
                          ...item,
                          person: this.UserAccept(item.attendances_id, item.accept_id)
                      }
                  })
              },
              filteredItems() {
          ...
          methods: {
            ...
            editItem  (item) {
                ...
                this.dialog = true
                console.log(this.attens)
            },
              submit() {
                  console.log(`Selected date range: ${this.filter.start} - ${this.filter.end}`);
              },
                          close () {
                this.dialog = false
                this.$nextTick(() => {
