...
export default {
  data: () => ({
    ...
    headers: [
      { title: "Order ID", key: "id", class: " white--text", align: "start" },
      { title: "Order By", key: "username", class: " white--text" },
      { title: "Order for", key: "order_for", class: " white--text" },
      {  title: "Type", key: "atm_type", class: " white--text" },
      {  title: "Model", key: "atm_model", class: " white--text" },
      {  title: "Category", key: "category", class: " white--text" },
      {  title: "Quantity", key: "amount", class: " white--text" },
      {  title: "Order Date", key: "created_at", class: " white--text" },
      {  title: "Arrival Time", key: "arrival_date", class: " white--text" },
      {  title: "Warehouse", key: "warehouse", class: " white--text" },
      {  title: "Status", key: "status", class: " white--text" },
      {
        text: "Actions",
        value: "actions",
        sortable: false,
    ...
    headers1: [
      ...
      { title: "forSellorRest", key: "forSellorRest", class: " white--text" },
      { title: "Status", key: "status", class: " white--text" },
      {
        title: "Actions",
        key: "action",
  ...
  methods: {
    ...
    deleteItemConfirm() {
      ...
      axios.delete('/api/IMS/order/deleteorder/'+this.editedItem.id)
    ...
    save(item) {
      ...
      if (this.editedIndex > -1) {
        ...
        axios.put('/api/IMS/order/update/'+this.editedItem.id, this.editedItem)
