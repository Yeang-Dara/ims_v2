...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { title: "Serail Number", key: "serial_number", class: " white--text" },
      ...
      { titel: "Install Date", key: "install_date", class: " white--text" },
        { title: "Status", key: "status", class: " white--text" },
      { title: "Addess", key: "address", class: " white--text", width: '30%'  },
  ...
  methods: {
    ...
    getUsing() {
        axios.post('/api/IMS/using/fiterdata', this.filter)
    ...
    Export(){
        axios.get('/api/IMS/using/export')
    //   Using.getExport()
       .then((Response) => {
