...
export default {
  data: () => ({
    ...
    itemsPerPage: 10,
    headers: [
      { title: "ATM ID", key: "atm_id", class: " white--text" },
      { title: "Bank Name", key: "bank_name", class: " white--text" },
      { title: "Type", key: "type_name", class: " white--text" },
      { title: "Model", key: "model_name", class: " white--text" },
      { title: "Serial Number", key: "serial_number", class: " white--text" },
      { title: "Warranty", key: "warranty_days", class: " white--text" },
      { title: "Take Over Date", key: "take_over_date", class: " white--text", },
      { title: "Location", key: "location", class: " white--text" },
      { title: "Region", key: "region_name",class: " white--text",},
      { title: "Status", key: "status",class: " white--text",sortable: false},
      { title: "Actions", key: "actions",sortable: false,class: " white--text",},
    ],
    reports: [],
    editedIndex: -1,
    editedItem: {
  ...
  methods: {
    report() {
        axios.get('/api/IMS/using/report')
    //   Using.getReport()
      .then((response) => {
