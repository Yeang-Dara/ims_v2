...
export default {
  data: () => ({
    ...
    spareparts: [],
    headers: [
      { title: "Spare part Name", key: "spareparts_name", class: " white--text"},
      { title: "Part Number", key: "part_number", class: " white--text" },
      { title: "Total Quantity", key: "quantity", class: " white--text" },
      { title: "Quantity Used", key: "quantity_used", class: " white--text" },
      { title: "Quantity Remain", key: "quantity_used", class: " white--text"},
      { title: "For Model", key: "for_machine_model", class: " white--text" },
