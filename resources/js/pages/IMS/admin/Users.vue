        ...
        <v-row style="padding: 10px; height: 90%">
          ...
          <v-alert :value="error" type="error">Delete Successfully! </v-alert> -->
                ...
                <v-card-container>
                    ...
                    <v-card
                        style="margin-top: 30px; padding: 20px; width: 100%"
                        flat
                    >
                        <v-card>
                            <div class="parent">
...
export default {
    ...
    methods: {
        ...
        deleteItemConfirm() {
            ...
            axios
                .delete("/api/IMS/user/deleteuser/" + this.editedItem.id)
        ...
        save() {
            if (this.editedIndex > -1) {
                ...
                axios
                    .put(
                        "/api/IMS/user/updateuser/" + this.editedItem.id,
                        this.editedItem
                    )
