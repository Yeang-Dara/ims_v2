<template>
  <v-app>
    <v-navigation-drawer v-model="drawer" app class="mx-auto" width="300">
      ...
      >
        <div v-if="navigator.group1">
          <v-list-group v-for="item in navigator.items"
            :key="item.title"
            v-model="item.active"
            ...
            <v-list-group  v-for="(item, i) in item.items"
              :key="i"
              :value="item"
              link
            >
                ...
                <v-list-item v-for="(nestedItem, j) in item.items"
                :key="j" :title="nestedItem.title"
        ...
        <div v-else-if="navigator.group">
          ...
          >
            ...
            <v-list-item-title>
                <router-link :to="item.link" style="text-decoration: none; color: inherit;">{{ item.title }}</router-link>
            </v-list-item-title>
            </v-list-item>
          </v-list-group>
        </div>
